...
*                                                                                                               
* PURPOSE: This file implements the functions defined in quick_sort.h     
*                                                                                                               
* FILE REFERENCES:                                                                                              
*                                                                                                               
...
* ----------    ---------------         ---------       -------         ---------------------   
* 26-06-2025    Tiago Rodrigues                               0         File preparation     
*
*
* ALGORITHM (PDL)
*    
...
void quick_sort_rec(void** array_of_values, uint64_t size_of_array, uint64_t size_of_datatype, int64_t left, int64_t right, uint8_t (*compare_function)(void* elem1, void* elem2));
...
void quick_sort(void** array_of_values, uint64_t size_of_array, uint64_t size_of_datatype, uint8_t (*compare_function)(void* elem1, void* elem2))
{
        ...
        */
        ...
        quick_sort_rec(array_of_values, size_of_array, size_of_datatype, 0, size_of_array-1, compare_function);
...
/******************************************************************
*
* FUNCTION NAME: quick_sort_rec  
*
* PURPOSE: Definition of the recursive part of the quick sort algorithm
*
* ARGUMENTS:
*
* ARGUMENT 	        TYPE	        I/O	DESCRIPTION
...
void quick_sort_rec(void** array_of_values, uint64_t size_of_array, uint64_t size_of_datatype, int64_t left, int64_t right, uint8_t (*compare_function)(void* elem1, void* elem2))
{
        ...
        if(left<right && left >=0)
        {
                ...
                {
                        if(!compare_function((void *) &((uint8_t*)(*array_of_values))[i*size_of_datatype],(void *) &((uint8_t*)(*array_of_values))[(right)*size_of_datatype]))
                        {
                                memcpy(aux_swap, (void *) &((uint8_t*)(*array_of_values))[i*size_of_datatype], size_of_datatype); 
                                memcpy((void *) &((uint8_t*)(*array_of_values))[i*size_of_datatype], (void *) &((uint8_t*)(*array_of_values))[(pivot)*size_of_datatype], size_of_datatype);
                                memcpy((void *) &((uint8_t*)(*array_of_values))[(pivot)*size_of_datatype], aux_swap, size_of_datatype);  
                                pivot++;
                        }
                }

                memcpy(aux_swap, (void *) &((uint8_t*)(*array_of_values))[right*size_of_datatype], size_of_datatype); 
                memcpy((void *) &((uint8_t*)(*array_of_values))[right*size_of_datatype], (void *) &((uint8_t*)(*array_of_values))[(pivot)*size_of_datatype], size_of_datatype);
                memcpy((void *) &((uint8_t*)(*array_of_values))[(pivot)*size_of_datatype], aux_swap, size_of_datatype);  

                free(aux_swap);     
         
         
                quick_sort_rec(array_of_values, size_of_array, size_of_datatype, left, pivot-1, compare_function);
                quick_sort_rec(array_of_values, size_of_array, size_of_datatype, pivot+1, right, compare_function);
