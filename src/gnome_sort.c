/*******************************************************************************************************************
* FILE NAME: gnome_sort.c
*                                                                                                               
* PURPOSE: This file implements the functions defined in gnome_sort.h     
*                                                                                                               
* FILE REFERENCES:                                                                                              
*                                                                                                               
...
void gnome_sort(void** array_of_values, uint64_t size_of_array, uint64_t size_of_datatype, uint8_t (*compare_function)(void* elem1, void* elem2))            
{
        ...
        */
        ...
        for(uint64_t i=0; i<size_of_array;)
        {
                if((0 != i) && compare_function((void *) &((uint8_t*)(*array_of_values))[(i-1)*size_of_datatype],(void *) &((uint8_t*)(*array_of_values))[i*size_of_datatype]))
                {
                        memcpy(aux_swap, (void *) &((uint8_t*)(*array_of_values))[i*size_of_datatype], size_of_datatype); 
                        memcpy((void *) &((uint8_t*)(*array_of_values))[i*size_of_datatype], (void *) &((uint8_t*)(*array_of_values))[(i-1)*size_of_datatype], size_of_datatype);
                        memcpy((void *) &((uint8_t*)(*array_of_values))[(i-1)*size_of_datatype], aux_swap, size_of_datatype);  
                        i--;
                }
                else
                {
