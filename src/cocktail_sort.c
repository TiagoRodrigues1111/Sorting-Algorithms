/*******************************************************************************************************************
* FILE NAME: cocktail_sort.c
*                                                                                                               
* PURPOSE: This file implements the functions defined in cocktail_sort.h     
*                                                                                                               
* FILE REFERENCES:                                                                                              
*                                                                                                               
...
void cocktail_sort(void** array_of_values, uint64_t size_of_array, uint64_t size_of_datatype, uint8_t (*compare_function)(void* elem1, void* elem2))
{
        ...
        */
        ...
        {
                for(uint64_t j=i; j<size_of_array-i-1; j++)
                {
                ...
                changes = 0;
                for(uint64_t j=(size_of_array-i-2); j>i; j--)
                {
                        if(!compare_function((void *) &((uint8_t*)(*array_of_values))[j*size_of_datatype],(void *) &((uint8_t*)(*array_of_values))[(j-1)*size_of_datatype]))
                        {       
                                memcpy(aux_swap, (void *) &((uint8_t*)(*array_of_values))[j*size_of_datatype], size_of_datatype); 
