/*******************************************************************************************************************
* FILE NAME: odd_even_sort.c
*                                                                                                               
* PURPOSE: This file implements the functions defined in odd_even_sort.h     
*                                                                                                               
* FILE REFERENCES:                                                                                              
*                                                                                                               
...
void odd_even_sort(void** array_of_values, uint64_t size_of_array, uint64_t size_of_datatype, uint8_t (*compare_function)(void* elem1, void* elem2))
{
        ...
        */
        ...
        {
                for(uint64_t j=1;j<size_of_array-1;j+=2)
                {
                ...
                for(uint64_t j=0;j<size_of_array-1;j+=2)
                {
                        if(compare_function((void *) &((uint8_t*)(*array_of_values))[j*size_of_datatype],(void *) &((uint8_t*)(*array_of_values))[(j+1)*size_of_datatype]))
                        {       
                                memcpy(aux_swap, (void *) &((uint8_t*)(*array_of_values))[j*size_of_datatype], size_of_datatype); 
